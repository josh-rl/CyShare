...
public class BookingDetails {
    ...
    private List<PassengerBookingDetails> Requests = new ArrayList<>();

    public List<PassengerBookingDetails> getRequests() {
        return Requests;
    }

    public void setRequests(PassengerBookingDetails requests) {
